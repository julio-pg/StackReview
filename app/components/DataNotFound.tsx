export default function DataNotFound({ title }: { title: string }) {
  return (
    <div className="flex flex-col gap-4 items-center">
      <div className="w-20 h-20 mx-auto bg-gray-50 dark:bg-gray-800 rounded-full shadow-sm justify-center items-center inline-flex">
        <svg
